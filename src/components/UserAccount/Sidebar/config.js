...
export default [
   {
      id: 'home',
      title: tr('user_account_sidebar_menu_home'),
   ...
   {
      id: 'tasks',
      title: tr('user_account_sidebar_menu_tasks'),
   ...
   {
      id: 'calendar',
      title: tr('user_account_sidebar_menu_calendar'),
   ...
   {
      id: 'plans',
      title: tr('user_account_sidebar_menu_plans'),
   ...
   {
      id: 'board',
      title: tr('user_account_sidebar_menu_board'),
   ...
   {
      id: 'teams',
      title: tr('user_account_sidebar_menu_teams'),
